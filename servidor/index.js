...
app.post('/ultimoEntrenamiento/', function(req, res){/*Verificar el estado del ultimo entrenamiento*/
    ...
    app.post('/intentosDetalle/', function(req, res){/*listado de intentos realizados"*/
      ...
      var usuario = req.body;
        ...
        var sql = "select en.identrenamiento as identrenamiento, en.usuario_idusuario as idusuario, en.repeticion as repeticion, en.estado as estado, cast(en.fecha as time)  as fecha, cast(en.fecha as date)  as fecha2,  cast(en.fecha as varchar)  as fecha3 from entrenamiento as en  where  en.usuario_idusuario ="+usuario.idusuario+" and en.estado = 4 and en.fecha is not null; ";
        console.log(sql);
        mysqlConnection.query(sql,(err, rows,fields)=>{
          if(!err){
