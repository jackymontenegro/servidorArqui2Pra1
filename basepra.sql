...
CREATE TABLE IF NOT EXISTS `mydb`.`repeticion` (
  ...
  `distanciaTotal` FLOAT NULL DEFAULT 0,
...
-- -----------------------------------------------------
-- Table `mydb`.`velocidad`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`velocidad` (
  `idvelocidad` INT NOT NULL AUTO_INCREMENT,
  `fecha` DATETIME NULL,
  `velocidad` FLOAT NULL,
  `repeticion_idrepeticion` INT NOT NULL,
  PRIMARY KEY (`idvelocidad`),
  INDEX `fk_velocidad_repeticion1_idx` (`repeticion_idrepeticion` ASC),
  CONSTRAINT `fk_velocidad_repeticion1`
    FOREIGN KEY (`repeticion_idrepeticion`)
    REFERENCES `mydb`.`repeticion` (`idrepeticion`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
