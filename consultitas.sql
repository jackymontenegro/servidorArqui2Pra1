...
insert into usuario (nombre, fechaNacimiento, peso,altura,tipo_idtipo,correo,contra,usuario_idusuario) 
values ('jacky',STR_TO_DATE('19/04/1999','%d/%m/%Y'),155,168,1,'prueba2@gmail.com','123',1);

insert into usuario (nombre, fechaNacimiento, peso,altura,tipo_idtipo,correo,contra,usuario_idusuario) 
values ('sofia',STR_TO_DATE('19/04/1999','%d/%m/%Y'),155,168,2,'prueba3@gmail.com','123',1);
